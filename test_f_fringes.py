...
def test_delete_fringes(driver):
    select_fringe_setup = driver.find_element_by_css_selector('div.actions.tools-setup > button:nth-child(2)')
    select_fringe_setup.click()
    driver.implicitly_wait(5)
    driver.switch_to.window(driver.window_handles[1])
    driver.implicitly_wait(5)
    delete_fringe = driver.find_element_by_css_selector('div > div.tools-actions > div > a:nth-child(2) > i')
    delete_fringe.click()
    driver.implicitly_wait(5)
